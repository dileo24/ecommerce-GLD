    ...
    <div className={style.Div}>
      ...
      <div className={style.contentAbout}>
            ...
            <div className={style.card_description}>
              ...
              <p className={style.text_body}>
                <div className={style.contacto}>
                  <a
                    href="https://github.com/Caarlos94"
                    target="_blank"
                    rel="noreferrer"
                  >
                  ...
                  <a
                    href="https://www.linkedin.com/mwlite/in/juan-carlos-islas-lopez"
                    target="_blank"
                    rel="noreferrer"
                  >
          ...
          <div className={style.card}>
            ...
            <div className={style.card_description}>
              ...
              <p className={style.text_body}>
                <div className={style.contacto}>
                  <a
                    href="https://github.com/mederocc"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <img src={gitHub} alt="github" />
            ...
            <div className={style.card_description}>
              ...
              <p className={style.text_body}>
                <div className={style.contacto}>
                  ...
                  <a
                    href="https://www.linkedin.com/in/cesar-zegarra-b55061255/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <img src={linkedIn} alt="cv" />
          ...
          <div className={style.card}>
            ...
            <div className={style.card_description}>
              ...
              <p className={style.text_body}>
                <div className={style.contacto}>
                  <a
                    href="https://github.com/belidavalos11"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <img src={gitHub} alt="github" />
                  ...
                  <a
                    href="https://www.linkedin.com/in/belisario-davalos-704827192/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <img src={linkedIn} alt="cv" />
        ...
        <div className={style.divData}>
          <h3>
            SupraSports es una página dedicada a la venta de indumentaria
            deportiva.
          </h3>
          ...
          <h6>
            ...
            <br />
            Creación/eliminción de categorías.
            <br />
            Barra de búsqueda.
            <br />
            Preguntas y respuestas.
            <br />
            Registro de ventas con ordenamientos propios.
            <br />
